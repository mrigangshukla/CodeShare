...
import { Earth, Code2, Sparkles } from "lucide-react";
import Link from "next/link";
import TypingText from "./TypingText";
import AnimatedS from "./AnimatedS";
import AnimatedCodeShare from "./AnimatedCodeShare";
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/" className="flex items-center gap-3 group relative">
              ...
              <div className="relative bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0f] p-2 rounded-xl ring-1 ring-white/10 group-hover:ring-white/20 transition-all">
                 < Earth className="w-6 h-6 text-blue-400 transform -rotate-6 group-hover:rotate-0 transition-transform duration-500" />
              </div>
              ...
              <div className="relative">
                ...
                <span className="block text-xs text-blue-400/60 font-medium h-4 min-w-[11rem]">
                <TypingText />
              </span>
